...
public class TreeViewAdapter extends BaseTreeViewAdapter {
	...
	private String[] mGroups = { "Group 01", "Group 02", "Group 03",
			"Group 04", "Group 05", "Group 06", "Group 07", "Group 08",
			"Group 09", "Group 10", "Group 11", "Group 12", "Group 13",
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.treeview_list_item_view,
					null);
		}

		ChildHolder holder = getChildHolder(convertView);
		holder.name.setText(String.valueOf(getChild(groupPosition,
				childPosition)));
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.treeview_list_group_view,
					null);
		}
		...
		if (isExpanded) {
			holder.indicator
					.setImageResource(R.drawable.treeview_indicator_expanded);
		} else {
			holder.indicator
					.setImageResource(R.drawable.treeview_indicator_unexpanded);
		}

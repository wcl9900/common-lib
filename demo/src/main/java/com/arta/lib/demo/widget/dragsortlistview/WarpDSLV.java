...
public class WarpDSLV extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dragsortlistview_warp_main);
        ...
        adapter = new ArrayAdapter<String>(this, R.layout.dragsortlistview_list_item_handle_right, R.id.text, list);

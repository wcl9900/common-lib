package com.arta.lib.demo.convenientbanner.recyclerview;
...
import com.arta.lib.demo.convenientbanner.NetworkImageHolderView;
...
public class ADRecyclerViewDemo extends Activity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initViews() {
        setContentView(R.layout.convenientbanner_acitvity_adrecyclerviewdemo);
        refreshLayout = (SwipeRefreshLayout) findViewById(R.id.refreshLayout);
        convenientBanner = (ConvenientBanner) LayoutInflater.from(this).inflate(R.layout.convenientbanner_adapter_header_cb,null);

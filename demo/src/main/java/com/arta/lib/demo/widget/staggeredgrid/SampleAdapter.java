...
import com.arta.lib.widget.staggeredgrid.util.DynamicHeightTextView;
...
public class SampleAdapter extends ArrayAdapter<String> {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        ViewHolder vh;
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.staggeredgrid_list_item_sample, parent, false);
            vh = new ViewHolder();

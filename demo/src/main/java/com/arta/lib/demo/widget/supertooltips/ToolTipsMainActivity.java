package com.arta.lib.demo.widget.supertooltips;
...
import com.arta.lib.widget.supertooltips.ToolTip;
import com.arta.lib.widget.supertooltips.ToolTipRelativeLayout;
import com.arta.lib.widget.supertooltips.ToolTipView;

public class ToolTipsMainActivity extends Activity implements View.OnClickListener, ToolTipView.OnToolTipViewClickedListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tooltips_activity_main);
    ...
    private void addPurpleToolTipView() {
        ToolTip toolTip = new ToolTip()
                .withContentView(LayoutInflater.from(this).inflate(R.layout.tooltip_custom, null))

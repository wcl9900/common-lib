package com.arta.lib.demo.widget.badgeview;
...
import com.arta.lib.widget.badgeview.BadgeView;

public class BadgeViewMainActivity extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.badgeview_main);
        ...
        badge5.setText("37");
        badge5.setBackgroundResource(R.drawable.badgeview_ifaux);
    	...
    	badge6.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Toast.makeText(BadgeViewMainActivity.this, "clicked badge", Toast.LENGTH_SHORT).show();
			}
		});

package com.arta.lib.demo.widget.progresswheel;
...
import com.arta.lib.widget.progresswheel.ProgressWheel;

/**
 * A sample activity showing some of the functions of the progress bar 
 */
public class ProgressWheelMainActivity extends Activity {
	boolean running;

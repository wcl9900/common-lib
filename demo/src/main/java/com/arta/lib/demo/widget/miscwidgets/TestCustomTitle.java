...
public class TestCustomTitle extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.miscwidgets_i_main);
        getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.miscwidgets_i_title);
        ...
        final Animation slideInLeft = AnimationUtils.loadAnimation(this, R.anim.miscwidgets_i_slide_in_left);
        final Animation slideInRight = AnimationUtils.loadAnimation(this, R.anim.miscwidgets_i_slide_in_right);
        final Animation slideOutLeft = AnimationUtils.loadAnimation(this, R.anim.miscwidgets_i_slide_out_left);
        final Animation slideOutRight = AnimationUtils.loadAnimation(this, R.anim.miscwidgets_i_slide_out_right);

...
import com.arta.lib.widget.draglistview.DragSortListView.RemoveListener;
...
public class MultipleChoiceListView extends ListActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dragsortlistview_checkable_main);
        
        String[] array = getResources().getStringArray(R.array.jazz_artist_names);
        ArrayList<String> arrayList = new ArrayList<String>(Arrays.asList(array));

        adapter = new ArrayAdapter<String>(this, R.layout.dragsortlistview_list_item_checkable, R.id.text, arrayList);

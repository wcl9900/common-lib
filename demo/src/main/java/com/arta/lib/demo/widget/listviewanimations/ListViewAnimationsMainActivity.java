 ...
 */
package com.arta.lib.demo.widget.listviewanimations;
...
import com.arta.lib.demo.widget.listviewanimations.appearanceexamples.AppearanceExamplesActivity;
import com.arta.lib.demo.widget.listviewanimations.itemmanipulationexamples.ItemManipulationsExamplesActivity;

public class ListViewAnimationsMainActivity extends Activity {
...
//		}
		...
		setContentView(R.layout.activity_listviewanimation_main);
...
//
//		@Override
//		public void onServiceConnected(final ComponentName name, final IBinder servicmService = IInAppBillingService.Stub.asInterface(service);
//		//			supportInvalidateOptionsMenu();
//
//		new Thread() {
//

package com.arta.lib.demo.widget.square_progressbar.dialogs;
...
import com.arta.lib.demo.widget.square_progressbar.PreviewView;
import com.arta.lib.widget.square_progressbar.utils.PercentStyle;
...
public class PercentDialog extends Dialog {
	...
	public PercentDialog(final Context context) {
		...
		this.setContentView(R.layout.square_progressbar_percentdialog);

...
public class ListViewTestActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.percent_support_extends_activity_list_view_test);
        ...
        mListView.setAdapter(new ArrayAdapter<String>(this, -1, mStr)
        {
            ...
            public View getView(int position, View convertView, ViewGroup parent)
            {
                if (convertView == null)
                {
                    convertView = mInflater.inflate(R.layout.percent_support_extends_item_music_list, parent, false);
                }

package com.arta.lib.demo.widget.textdrawable;
...
import com.arta.lib.demo.widget.textdrawable.item.DrawableProvider;
import com.arta.lib.widget.textdrawable.TextDrawable;
import com.arta.lib.widget.textdrawable.util.ColorGenerator;
...
public class ListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int type = intent.getIntExtra(TextDrawableMainActivity.TYPE, DrawableProvider.SAMPLE_RECT);
    ...
    private class SampleAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(ListActivity.this, R.layout.textdrawable_list_item_layout, null);

package com.arta.lib.demo.widget.aligntextview.example;
...
import com.arta.lib.widget.aligntextview.CBAlignTextView;
...
public class AlignTextViewExample extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String text = "这是一段中英文混合的文本，I am very happy today。 aaaaaaaaaa," +
                ...
                "CBAlignTextView可以像原生TextView一样操作, 但是需要使用getRealText()获取文本, 欢迎访问open.codeboy.me 010-5780988";
...
//        cbAlignTv.setPunctuationConvert(true);
        ...
        cbAlignTv.setMovementMethod(LinkMovementMethod.getInstance());

...
public class Issue51Activity extends Activity {
  ...
  private static class MyBaseAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      if (position == 0) {
        return inflater.inflate(R.layout.flipview_page1, null);
      } else if (position == 1) {
        return inflater.inflate(R.layout.flipview_page2, null);
      } else {
        return inflater.inflate(R.layout.flipview_page3, null);
      }
    }
  }
}

package com.arta.lib.demo.widget.flipview.adapter;
...
import com.arta.lib.demo.widget.flipview.data.Travels;
import com.arta.lib.widget.flipview.utils.AphidLog;
import com.arta.lib.widget.flipview.utils.IO;
import com.arta.lib.widget.flipview.utils.UI;
...
public class TravelAdapter extends BaseAdapter {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
      layout = inflater.inflate(R.layout.flipview_complex1, null);

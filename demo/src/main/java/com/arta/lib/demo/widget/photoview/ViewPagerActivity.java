...
public class ViewPagerActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.photoview_activity_view_pager);
...
//			photoView.setImageResource(sDrawables[position]);
			photoView.setImageBitmap(ResourceUtil.getResBitmap(container.getContext(), R.drawable.wallpaper));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.photoview_viewpager_menu, menu);

...
import com.arta.lib.widget.draglistview.SimpleDragSortCursorAdapter;
...
public class CursorDSLV extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dragsortlistview_cursor_main);

        String[] cols = {"name"};
        int[] ids = {R.id.text};
        adapter = new MAdapter(this,
                R.layout.dragsortlistview_list_item_click_remove, null, cols, ids, 0);

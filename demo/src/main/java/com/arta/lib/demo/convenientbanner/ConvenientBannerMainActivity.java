package com.arta.lib.demo.convenientbanner;
...
import com.arta.lib.widget.convenientbanner.CBViewHolderCreator;
import com.arta.lib.widget.convenientbanner.ConvenientBanner;
import com.arta.lib.widget.convenientbanner.ConvenientBanner.Transformer;
 ...
 */
public class ConvenientBannerMainActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.convenientbanner_activity_main);
        initViews();
        init();
    }
    ...
    private void initViews() {
        ...
        transformerArrayAdapter = new ArrayAdapter(this,R.layout.convenientbanner_adapter_transformer,transformerList);
    ...
    private void init(){
        ...
        convenientBanner.setPages(
                ...
                .setPageIndicator(new int[]{R.drawable.convenientbanner_ic_page_indicator, R.drawable.convenientbanner_ic_page_indicator_focused})
                //设置翻页的效果，不需要翻页效果可用不设
...
//        },networkImages);
    ...
    private void initImageLoader(){
        ...
        DisplayImageOptions defaultOptions = new DisplayImageOptions.Builder().
                showImageForEmptyUri(R.drawable.convenientbanner_ic_default_adimage)
    ...
    * */
    private void loadTestDatas() {
        ...
        for (int position = 0; position < 7; position++)
            localImages.add(getResId("convenientbanner_ic_test_" + position, R.drawable.class));

package com.arta.lib.demo.widget.multiactiontextview;
...
import com.arta.lib.widget.multiactiontextview.InputObject;
import com.arta.lib.widget.multiactiontextview.MultiActionTextView;
import com.arta.lib.widget.multiactiontextview.MultiActionTextviewClickListener;


public class MultiActionTextviewMainActivity extends Activity {
	...
	private final String TAG = MultiActionTextviewMainActivity.class.getSimpleName();

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.multiactiontextview_activity_main);

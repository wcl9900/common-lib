package com.arta.lib.demo.widget.slideexpandable;
...
import com.arta.lib.widget.slideexpandable.ActionSlideExpandableListView;
 ...
 */
public class SlideExpandableActivity extends Activity {
	...
	public void onCreate(Bundle savedData) {
		...
		this.setContentView(R.layout.slideexpandable_single_expandable_list);
	...
	public ListAdapter buildDummyData() {
		...
		return new ArrayAdapter<String>(
				this,
				R.layout.slideexpandable_expandable_list_item,
				R.id.text,
				values
		);
	}

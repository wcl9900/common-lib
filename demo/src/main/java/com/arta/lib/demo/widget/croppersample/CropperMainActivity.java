...
package com.arta.lib.demo.widget.croppersample;
...
public class CropperMainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cropImageView.setImageBitmap(ResourceUtil.getResBitmap(this,R.drawable.ic_launcher));

package com.arta.lib.demo.widget.wheel;
...
import com.arta.lib.widget.wheel.WheelView;
import com.arta.lib.widget.wheel.adapters.AbstractWheelTextAdapter;
import com.arta.lib.widget.wheel.adapters.ArrayWheelAdapter;
import com.arta.lib.widget.wheel.adapters.NumericWheelAdapter;
...
public class Time2Activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wheel_time2_layout);
    ...
    private class DayArrayAdapter extends AbstractWheelTextAdapter {
        ...
        protected DayArrayAdapter(Context context, Calendar calendar) {
            super(context, R.layout.wheel_time2_day, NO_RESOURCE);

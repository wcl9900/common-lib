...
import com.arta.lib.widget.miscwidgets.widget.Switcher;

public class TestSwitcher extends Activity {
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.miscwidgets_switcher_main);
		String[] data0 = {
		        "january",
		        "february",
		        "march",
		...
		ArrayAdapter<String> adapter0 = new ArrayAdapter<String>(this, R.layout.miscwidgets_switcher_view, data0);
		...
		ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(this, R.layout.miscwidgets_switcher_view, data1);
		...
		ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(this, R.layout.miscwidgets_switcher_view, data2);

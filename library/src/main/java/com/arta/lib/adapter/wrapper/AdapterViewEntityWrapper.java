...
import com.arta.lib.widget.PageIndicatorView;
import com.arta.lib.widget.listener.OnEntityViewClickListener;
import com.arta.lib.widget.listener.OnEntityViewLongClickListener;

/**
 * AdapterView 列表视图包装类。可用于对AdapterView进行基于{@link BaseEntityViewAdapter}
 * 适配器的数据绑定；可以设定 指示器{@link PageIndicatorView}；可以使用实体数据监听器
...
public class AdapterViewEntityWrapper<T> implements OnItemClickListener,
	...
	private PageIndicatorView indictor;
	...
	public void setAdapter(Adapter adapter) {
		if (getAdapterView() != null) {
			...
			if (indictor != null) {
				indictor.setAdapterView(getAdapterView());
			}
		}
	}
	 ...
	 * @param indictor
	 */
	public void setIndictor(PageIndicatorView indictor) {
	...
	private Adapter getAdapter() {
		...
		if (adapterView.getAdapter() != null) {
			...
			} else if (adapterView.getAdapter() instanceof com.arta.lib.widget.staggeredgrid.HeaderViewListAdapter) {
				adapter = ((com.arta.lib.widget.staggeredgrid.HeaderViewListAdapter) adapterView
						.getAdapter()).getWrappedAdapter();
			}
		}
		return adapter;
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		if (itemClickListener != null) {
			...
			} else if (parent.getAdapter() instanceof com.arta.lib.widget.staggeredgrid.HeaderViewListAdapter) {
				position = position
						- ((com.arta.lib.widget.staggeredgrid.HeaderViewListAdapter) parent
								.getAdapter()).getHeadersCount();
			}
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position,
			long id) {
		if (indictor != null) {
			indictor.setCurrentPage(position);
		}

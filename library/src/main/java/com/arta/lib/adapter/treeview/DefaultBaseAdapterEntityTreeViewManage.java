 ...
 * @param <T2> 子视图数据实体
 */
public abstract class DefaultBaseAdapterEntityTreeViewManage<T1, T2> implements
		BaseAdapterEntityTreeViewManage<T1, T2> {

	private int resIdChild;
	private int resIdGroup;
	
	public DefaultBaseAdapterEntityTreeViewManage(int resIdGroup, int resIdChild) {
		super();

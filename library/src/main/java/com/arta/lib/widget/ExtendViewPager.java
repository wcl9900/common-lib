...
public class ExtendViewPager extends ViewPager {
	...
	public static final String TAG = "ExtendViewPager";
	...
	public ExtendViewPager(Context context, AttributeSet attrs) {
		...
		int effect = ta.getInt(R.styleable.ExtendViewPager_style, 0);
		...
		setFadeEnabled(ta.getBoolean(R.styleable.ExtendViewPager_fadeEnabled, false));
		setOutlineEnabled(ta.getBoolean(R.styleable.ExtendViewPager_outlineEnabled, false));
		setOutlineColor(ta.getColor(R.styleable.ExtendViewPager_outlineColor, Color.WHITE));
		switch (mEffect) {
		case Stack:
		case ZoomOut:
			setFadeEnabled(true);

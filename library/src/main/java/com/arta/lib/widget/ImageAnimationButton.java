 ...
 *
 */
public class ImageAnimationButton extends ImageButton {
	...
	public ImageAnimationButton(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initAttrs(attrs);
		initArgs();
	}

	public ImageAnimationButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		initAttrs(attrs);
		initArgs();
	}

	public ImageAnimationButton(Context context , AnimType animType_visible , AnimType animType_gone , int duration_visible,int duration_gone) {
		super(context);
	...
	private void initAnimListener(){
		visibleAnim.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationStart(Animation animation) {
				isPlaying = true;
				ImageAnimationButton.super.setVisibility(View.VISIBLE);
				ImageAnimationButton.this.setEnabled(true);
			...
			public void onAnimationEnd(Animation animation) {
				ImageAnimationButton.this.clearAnimation();
				isPlaying = false;
		...
		goneAnim.setAnimationListener(new AnimationListener() {
			...
			@Override
			public void onAnimationEnd(Animation animation) {
				ImageAnimationButton.super.setVisibility(View.INVISIBLE);
				ImageAnimationButton.this.setEnabled(false);
				ImageAnimationButton.this.clearAnimation();
				isPlaying = false;

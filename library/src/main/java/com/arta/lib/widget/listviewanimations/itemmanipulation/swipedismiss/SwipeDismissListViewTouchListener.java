 ...
 */
package com.arta.lib.widget.listviewanimations.itemmanipulation.swipedismiss;
...
import com.arta.lib.widget.listviewanimations.util.AdapterViewUtil;
 ...
 * clicks, etc.
 *
 * For performance reasons, do not use this class directly, but use the {@link com.arta.lib.widget.listviewanimations.itemmanipulation.swipedismiss.SwipeDismissAdapter}.
 */
...
public class SwipeDismissListViewTouchListener implements SwipeOnTouchListener {
    ...
    /**
     * Set the {@link com.arta.lib.widget.listviewanimations.itemmanipulation.swipedismiss.DismissableManager} to specify which views can or cannot be swiped.

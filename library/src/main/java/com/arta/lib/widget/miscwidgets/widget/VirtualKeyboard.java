package com.arta.lib.widget.miscwidgets.widget;
...
public class VirtualKeyboard extends View {
	...
	public VirtualKeyboard(Context context, AttributeSet attrs) {
		...
		btnDrawable = new ButtonDrawable(res, R.drawable.miscwidgets_vk_button);
		btnCtrlDrawable = new ButtonDrawable(res, R.drawable.miscwidgets_vk_button_ctrl);
		btnSelectedDrawable = new ButtonDrawable(res, R.drawable.miscwidgets_vk_button_selected);
		btnToggleSelectedDrawable = new ButtonDrawable(res, R.drawable.miscwidgets_vk_button_toggle_selected);
		
		BitmapDrawable zoomDrawable = (BitmapDrawable) context.getResources().getDrawable(R.drawable.miscwidgets_vk_zoom);
		zoomBitmap = zoomDrawable.getBitmap();
		BitmapDrawable handleDrawable = (BitmapDrawable) context.getResources().getDrawable(R.drawable.miscwidgets_vk_zoom_handle);
	...
	private void createBitmap(int w, int h) {
		...
		XmlPullParser xpp = getResources().getXml(R.xml.miscwidgets_layout);
		try {

...
import com.arta.lib.widget.listviewanimations.ListViewSetter;
...
public abstract class ExpandableListItemAdapter<T> extends ArrayAdapter<T> implements ListViewSetter {
    ...
    /**
     * Set the {@link com.arta.lib.widget.listviewanimations.itemmanipulation.ExpandCollapseListener} that should be notified of expand / collapse events.
     */

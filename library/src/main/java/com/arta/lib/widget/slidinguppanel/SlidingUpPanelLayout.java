package com.arta.lib.widget.slidinguppanel;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = getResources().getDrawable(R.drawable.slidinguppanel_above_shadow);
            } else {
                mShadowDrawable = getResources().getDrawable(R.drawable.slidinguppanel_below_shadow);
            }

package com.arta.lib.widget.treeview;
...
public class TreeView extends ExpandableListView implements OnScrollListener, OnGroupClickListener {
    ...
    private boolean clickHeaderEnable = true;
    ...
    public void setClickHeaderEnable(boolean clickHeaderEnable) {
		this.clickHeaderEnable = clickHeaderEnable;
	}
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mHeaderView != null && mUpdater != null) {

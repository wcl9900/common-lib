...
public class FancyCoverFlow extends Gallery {
    ...
    private void initialize() {
    	...
    	flyingThresHold = (int) (1300.0f * scale + 0.5f);
    }
    ...
    public void moveNext(){
    	sendMessage(MOVE_NEXT);
    }

    public void movePrevious(){
    	sendMessage(MOVE_PRE);
    }

...
import com.arta.lib.BuildConfig;
...
/*package*/ final class JumpingBeansSpan extends SuperscriptSpan implements ValueAnimator.AnimatorUpdateListener {
    ...
    public void onAnimationUpdate(ValueAnimator animation) {
        ...
        if (v != null) {
            if (isAttachedToHierarchy(v)) {
                shift = Integer.parseInt(animation.getAnimatedValue()+"");
                v.invalidate();
            } else {
     ...
     *
     * @see com.arta.lib.widget.jumpingbeans.JumpingBeans#DEFAULT_ANIMATION_DUTY_CYCLE
     */

...
public class AsymmetricGridView extends ListView {
    ...
    protected int requestedColumnHeight = -1;
	...
	public int getColumnHeight() {
		return requestedColumnHeight;
	}

	public void setRequestedColumnHeight(final int height) {
		this.requestedColumnHeight = height;
	}

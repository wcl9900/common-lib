...
package com.arta.lib.widget.cropper;
...
import com.arta.lib.widget.cropper.cropwindow.CropOverlayView;
import com.arta.lib.widget.cropper.cropwindow.edge.Edge;
import com.arta.lib.widget.cropper.util.ImageViewUtil;
...
public class CropImageView extends FrameLayout {
    ...
    private boolean cropEnable = true;
    ...
    public void setCropEnable(boolean cropEnable){
    	...
    	mCropOverlayView.setVisibility(cropEnable ? VISIBLE : GONE);
    }

...
import com.arta.lib.widget.asymmetricgridview.library.AsymmetricGridViewAdapterContract;
import com.arta.lib.widget.asymmetricgridview.library.AsyncTaskCompat;
import com.arta.lib.widget.asymmetricgridview.library.Utils;
import com.arta.lib.widget.asymmetricgridview.library.model.AsymmetricItem;
...
public abstract class AsymmetricGridViewAdapter<T extends AsymmetricItem>
    ...
    protected int getRowHeight(int rowSpan) {
        final int rowHeight = (listView.getColumnHeight() > 0 ? listView.getColumnHeight() : listView.getColumnWidth()) * rowSpan;
    ...
    private IcsLinearLayout findOrInitializeLayout(final View convertView) {
        ...
        if (convertView == null || !(convertView instanceof IcsLinearLayout)) {
            ...
            layout.setDividerDrawable(context.getResources().getDrawable(R.drawable.asymmetricgridview_item_divider_horizontal));
    ...
    private IcsLinearLayout findOrInitializeChildLayout(final LinearLayout parentLayout, final int childIndex) {
        ...
        if (childLayout == null) {
            ...
            childLayout.setDividerDrawable(context.getResources().getDrawable(R.drawable.asymmetricgridview_item_divider_vertical));

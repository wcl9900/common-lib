 ...
 *
 * <p>使用方法：
 * <p>BabushkaText babushka = (BabushkaText)findViewById(R.id.babushka_text);

 // Add the first piece "Central Park"
<p>babushka.addPiece(new BabushkaText.Piece.Builder("Central Park, NY\n")
 <p>.textColor(Color.parseColor("#414141"))
 <p>.build());

 // Add the second piece "1.2 mi"
 <p>babushka.addPiece(new BabushkaText.Piece.Builder("1.2 mi ")
 <p>.textColor(Color.parseColor("#0081E2"))
 <p>.textSizeRelative(0.9f)
 <p>.build());

 // Add the third piece "from here"
 <p>babushka.addPiece(new BabushkaText.Piece.Builder("from here")
 <p>.textColor(Color.parseColor("#969696"))
 <p>.textSizeRelative(0.9f)
 <p>.build());
